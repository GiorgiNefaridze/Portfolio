    ...
    return (
        <div className='projects-container'>
            <div className='projects-container-inner'>
                <p>Projects</p>
                <div className='projects-container-inner-content'>
                    {projects.map(language => (
                        <div key={language.id} className='project'>
                            <img src={language.poster} alt="poster"/>
                            <div className='project-inner'>
                                <span>{language.name}</span>
                                <div>
                                    <button onClick={()=> seeProject(language.liveVersion)}>
                                        See
                                        <svg
                                            fill="white"
                                            width="24"
                                    ...
                                    <button className={language.codeURL === "" ? "withoutCode" : ""} onClick={()=> codeOfProject(language.codeURL)}>
                                        Code
                                        <svg
                                            fill="white"
                                            xmlns="http://www.w3.org/2000/svg"
